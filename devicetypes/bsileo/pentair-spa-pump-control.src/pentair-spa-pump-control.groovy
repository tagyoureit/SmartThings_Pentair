 ...
 */
metadata {
	definition (name: "Pentair Spa Pump Control", namespace: "tagyoureit", author: "Russ Goldin") {
	capability "Switch"
        command onConfirmed
	...
	tiles {
		multiAttributeTile(name:"switch", type: "generic", width: 1, height: 1, canChangeIcon: true)  {
        	tileAttribute("device.switch", key: "PRIMARY_CONTROL") {
             	attributeState "off",  label:"Off", action:"on", nextState: "turningOn", icon: "https://tagyoureit.github.io/SmartThings_Pentair/spa.png",backgroundColor: "#ffffff"
            	attributeState "on", label:"On", action:"off",  nextState: "turningOff", icon: "https://tagyoureit.github.io/SmartThings_Pentair/spa.png",backgroundColor: "#00a0dc"
                attributeState "turningOn", label:'${name}', icon:"https://tagyoureit.github.io/SmartThings_Pentair/spa.png", backgroundColor:"#00a0dc", nextState: "on"
                attributeState "turningOff", label:'${name}', icon:"https://tagyoureit.github.io/SmartThings_Pentair/spa.png", backgroundColor:"#ffffff", nextState: "off"            	      
            }
