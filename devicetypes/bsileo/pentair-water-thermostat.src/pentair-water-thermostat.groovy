 ...
 */
metadata {
	definition (name: "Pentair Water Thermostat", namespace: "tagyoureit", author: "Russ Goldin") {
		capability "Actuator"
	...
	tiles {
		standardTile("mode", "device.thermostatMode", width:2, height:2, inactiveLabel: false, decoration: "flat") {
        	...
        	state "Solar Only", label:'${currentValue}', action:"nextMode",  nextState: "updating", icon: "https://tagyoureit.github.io/SmartThings_Pentair/solar-only.png"
            state "Solar Pref", label:'${currentValue}', action:"nextMode",  nextState: "updating", icon: "https://tagyoureit.github.io/SmartThings_Pentair/solar-preferred.jpg"
