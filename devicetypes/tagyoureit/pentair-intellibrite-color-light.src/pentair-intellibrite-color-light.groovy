 ...
 */
metadata {
	definition (name: "Pentair Intellibrite Color Light", namespace: "tagyoureit", author: "Russ Goldin") {		
		capability "Switch"
	...
	tiles {
		...
		/*	Future use if we find a way to show current state...
        	state "Party", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/party.png", backgroundColor:"#4250f4", nextState:"off"
            state "Romance", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/romance.png", backgroundColor:"#d28be8", nextState:"off"
            state "Caribbean", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/caribbean.png", backgroundColor:"#46f2e9", nextState:"off"        
            state "American", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/american.png", backgroundColor:"#d42729", nextState:"off"        
            state "Sunset", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/sunset.png", backgroundColor:"#ffff00", nextState:"off"        
            state "Royal", label:"", action:"off", icon:"https://tagyoureit.github.io/SmartThings_Pentair/royal.png", backgroundColor:"#9933ff", nextState:"off"        
