 ...
 */
metadata {
	definition (name: "Pentair Intellibrite Color Light Mode", namespace: "tagyoureit", author: "Russ Goldin") {
		capability "Actuator"
		capability "Switch"
	...
	tiles {
		standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true) {
			...
			state "Party", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/party.png", backgroundColor:"#4250f4", nextState:"on"
            state "Romance", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/romance.png", backgroundColor:"#d28be8", nextState:"on"
            state "Caribbean", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/caribbean.png", backgroundColor:"#46f2e9", nextState:"on"        
            state "American", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/american.png", backgroundColor:"#d42729", nextState:"on"        
            state "Sunset", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/sunset.png", backgroundColor:"#ffff00", nextState:"on"        
            state "Royal", label:"", action:"momentary.push", icon:"https://tagyoureit.github.io/SmartThings_Pentair/royal.png", backgroundColor:"#9933ff", nextState:"on"        
